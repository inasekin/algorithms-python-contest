...
def classical_hanoi(n, start, target, auxiliary):
    if n == 0:
        return
    classical_hanoi(n - 1, start, auxiliary, target)
    print(n, start, target)
    classical_hanoi(n - 1, auxiliary, target, start)

def solve(n, start, A, B):
    if n == 0:
        return
    if n % 2 == 1:
        target_n = A
    ...
    if start == target_n:
        ...
        T = 6 - start - target_n
        classical_hanoi(n - 1, start, T, target_n)
        print(n, start, target_n)
        solve(n - 1, T, A, B)
